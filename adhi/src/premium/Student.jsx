...
function Student() {
  ...
  useEffect(() => {
      ...
      axios
          .get('https://api.adhiinteriors.com/products/most-sell/sp:65a23b5fa48cc0053c481640')
          .then((response) => {
  ...
  return (
    ...
    <div className="flex flex-col md:flex-row  ml-5 mt-20">
      ...
      <div className="md:w-1/2 md:mr-4 text-center md:text-left ">
        <h1 className="text-3xl font-bold mb-2 w-fit">Student product</h1>
        <p className="text-gray-500 w-fit">Most selling</p>
        <div className="w-16 h-16 mb-10">
          <img src={studantproduct} className="w-16 h-16 relative left-60 bottom-14" alt="Bed" />
        </div>
      </div>
